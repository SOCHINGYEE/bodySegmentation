...
import { Form, Radio, Switch, Slider, message } from "antd";
...
const danmuLists = ["时 隔 四 年 依 然 经 典", "小小房间竟然人才辈出，实在是恐怖如斯", "《有生之年看到原版》", "以前的鲲鲲充满了自信和笑容", "梦开始的地方", "1.自我介绍", "这短暂的一分钟养活了多少up主（doge）", "万 恶 之 源", "《开 始 吟 唱》", "《名场面》", "《music》", "《经典咏流传》", "非物质文化遗产", "《文艺复兴》", "《白 带 异 常》", "梦开始的地方，我的梦回来了", "每一帧都是经典", "每一帧都是表情包诶", "《梦开始的地方》", "5.优雅转身", "前 方 高 能", "准备铁山靠", "《铁山靠》", "招式3:《铁 山 靠》", "坤法第一式：铁山靠", "小秘密：随便一帧都是经典画面", "《白鹤亮翅》", "跳水00:40", "《 老 肩 巨 滑 》", "《每天一遍，精神百倍》", "优雅，真的是优雅", "《经典永流传》", "《垂直握把》", "《起舞弄清影》", "每时每刻打开都有人在看系列", "《护裆派》", "《让我蠢蠢欲动》", "᭙ᦔꪀꪑᦔ，​", "这种感觉我从未有Cause I Got A Cush On You Who You", "武当（档）派", "爷不知道就他笑死了多少无辜的生命", "《国家宝藏》之家禽", "《无效定语从句》", "卧槽，每一帧都是万恶之源", "“鳖”", "每日一遍", "嘎子偷狗时代考察", "《亡之音》", "看见这个头型我就想笑", "最后亿遍", "期待的话，请多多为我投票吧！", "《作词作曲》", "你干嘛∽哈哈～哎呦", "糖果超甜", "笑死我了哈哈哈哈", "你是我的我是你的谁", "原版都这么滑稽哈哈哈", "你不要过来！！！", "《啥时候都有人》", "我的口头禅"]
...
async function recognition(){
  ...
  try{
    if(segmenter.current && isMaskOpen){
      ...
      // 压缩视频
      const imageData = await drawImageInCanvas(dplayer.current.video)
  ...
  return (
    <div className="App">
      <div className="container">
        <div id="container"  style={{maxWidth:'550px'}}></div>
        <br />
